...
export default function Navbar() {
  return (
    // Добавил z-[100], чтобы Navbar всегда был сверху
    <nav className="absolute top-0 left-0 w-full z-[100] flex justify-between items-center px-6 py-5 bg-transparent">
      ...
      <div className="flex items-center gap-4">
        {/* Обернул в div с минимальной шириной, чтобы Google script не "терялся" */}
        <div className="min-w-[150px] flex justify-end">
          <GoogleLogin
            onSuccess={credentialResponse => {
              console.log("Успешно! Токен:", credentialResponse.credential);
            }}
            onError={() => {
              console.log('Ошибка входа');
            }}
            theme="filled_blue" // Поменял на filled_blue для теста, она самая заметная
            size="medium"
            text="signin_with"
            shape="pill"
          />
